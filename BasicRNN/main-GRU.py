...
from BasicRNN.train_test import train_rnn1, language_model_test, sample, train_gru
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='GRU 实现字母级语言模型')
    # 训练相关参数
